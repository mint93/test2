...
import { OrderWithMeCoreModule } from 'app/core';
import { OrderWithMeAppRoutingModule } from './app-routing.module';
...
@NgModule({
    imports: [
        ...
        OrderWithMeCoreModule,
        OrderWithMeHomeModule,
        OrderWithMeAccountModule,
